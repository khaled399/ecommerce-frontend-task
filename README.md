...
- **Mobile-First**: All components are designed for mobile and scaled up
- **Breakpoints**: Tailwind's default breakpoints (sm, md, lg, xl, 2xl)
- **Touch Targets**: Minimum 48x48px for interactive elements
- **Images**: Responsive with proper aspect ratios (aspect-[4/3])
- **Navigation**: Collapsible menu for mobile views
